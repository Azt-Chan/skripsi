...
if($jml_tree==0){
	...
	if($jmlque==1){
		echo "<center><h1>Siswa sudah dilakukan prediksi..<br></h1>
			<strong>Jawaban sebelumnya:<br>
	...
	//jika belum melakukan prediksi
		...
		?>
		<center><b>Isi data prediksi</b></center>
		<form method=POST action='' >
			<table align='center'>
				...
				<tr>
					<td> &nbsp;&nbsp;<input name='sains' min="60" max="100" type='number' style="width:50px;" required="required"> </td>
				</tr>	
				...
				<tr>
					<td> &nbsp;&nbsp;<input name='math' min="60" max="100" type='number' style="width:50px;" required="required"> </td>
				</tr>
				...
				<tr>
					<td> &nbsp;&nbsp;<input name='bindo' min="60" max="100" type='number' style="width:50px;" required="required"> </td>
				</tr>
				...
				<tr>
					<td> &nbsp;&nbsp;<input name='bing' min="60" max="100" type='number' style="width:50px;" required="required"> </td>
				</tr>
				...
				<tr>
					<td> &nbsp;&nbsp;<input name='ips' min="60" max="100" type='number' style="width:50px;" required="required"> </td>
				</tr>

				<tr>
					<td colspan=3>6. Berapa nilai aqidah?</td>        
				</tr>
				<tr>
					<td> &nbsp;&nbsp;<input name='aqidah' min="60" max="100" type='number' style="width:50px;" required="required"> </td>
				</tr>	
		...
		<?php
			...
			echo "<h4><center>Hasil Jawaban ...<br>";
...
?>
<br><br>
<center><a href='index.php?menu=user' accesskey='5'>Kembali ke halaman user</a></center>